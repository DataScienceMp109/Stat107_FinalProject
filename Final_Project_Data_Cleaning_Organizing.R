...
# data cleaning
library(readr)
companylist <- read_csv("C:/Users/mac/Desktop/Financial Statistics 107/Final_Project/companylist.csv")
comls_nyse<-subset(companylist,subset=Sector!='n/a'&MarketCap!='n/a'&Sector!='n/a'
                   &(LastSale!='n/a'&LastSale>2))
...
summary(comls_nyse$MarketCap)[6]
...
samll_cap_com_lis<-subset(comls_nyse,subset=comls_nyse$MarketCap<as.numeric(samll_cap))
